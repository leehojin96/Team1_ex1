...
public class package_info {
	...
	public package_info(String pk_num, String pk_name, String schedule, String departure, String destination, int price,
			...
			String des_place1, String ht_key, String ht_name, String room_type, String amenities, String ht_offers,
	...
	public String toString() {
		return "package_info [pk_num=" + pk_num + ", pk_name=" + pk_name + ", schedule=" + schedule + ", Departure="
				...
				+ ht_name + ", room_type=" + room_type + ", amenities=" + amenities + ", ht_offers=" + ht_offers
				+ ", check_time=" + check_time + ", ht_ad=" + ht_ad + "]";
	}
